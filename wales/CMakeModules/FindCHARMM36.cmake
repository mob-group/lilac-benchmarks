# This file sets up the package CHARMM36.
...
set(CHARMM_SOURCE_ROOT ${SVN_ROOT}/CHARMM36)

# set the out-of-source directory where charmm will be built
unset(CHARMM_BUILD_ROOT CACHE)
set(CHARMM_BUILD_ROOT ${CMAKE_BINARY_DIR}/C36 CACHE TYPE STRING)
file(MAKE_DIRECTORY ${CHARMM_BUILD_ROOT})

# Note: CHARMM will fail if the file name of the ${CHARMM_BUILD_ROOT} is longer
# than about 49 characters.  (50 fails, 48 works)
...
message("${SVN_ROOT}/CMakeModules/FindCHARMM36.cmake: compiling CHARMM36 with arguments = ${CHARMM_COMPILE_ARGS}")                      
message("${SVN_ROOT}/CMakeModules/FindCHARMM36.cmake: charmm libs = ${CHARMM_LIBS}")
