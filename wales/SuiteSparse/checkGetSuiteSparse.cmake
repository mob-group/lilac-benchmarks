...
macro(SuiteSparse_unzip whichZipFile)
	...
	if(OFF)
		...
		execute_process( 	COMMAND ${7ZIP_CMD} x ${whichZipFile} -y
							WORKING_DIRECTORY ${${PROJECT_NAME}_SOURCE_DIR}	TIMEOUT 120
...
if(NOT EXISTS "${${PROJECT_NAME}_SOURCE_DIR}/SuiteSparse/CHOLMOD/Include/cholmod.h" AND NOT SUITESPARSE_DL_LAST)
...
if(SUITESPARSE_DL_LAST)
	...
	set(SUITESPARSE_ZIP "${${PROJECT_NAME}_SOURCE_DIR}/SuiteSparse.tar.gz")
