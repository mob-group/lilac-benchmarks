...
! variables for macroions

LOGICAL                       :: MACROIONT
INTEGER                       :: nmacroions
DOUBLE PRECISION              :: macroiondist

END MODULE MODAMBER9 

SUBROUTINE PERC ! we are calling PERC from within TAKESTEPAMBER in GMIN, so we need a placeholder for OPTIM
use commons, only : PERCT, PERCCUT

WRITE(*,*) 'This subroutine should not be called from OPTIM!'
