...
! MACHINE-DEPENDENT VALUES.
      IF (IRADX .EQ. 0) IRADX = MY_I1MACH (10)
      IF (NRDPLC .EQ. 0) NRDPLC = MY_I1MACH (14)
      IF (DZEROX .EQ. 0.0D0) IMINEX = MY_I1MACH (15)
      IF (DZEROX .EQ. 0.0D0) IMAXEX = MY_I1MACH (16)
      IF (NBITSX .EQ. 0) NBITSX = MY_I1MACH (8)
...
!              *** CRAY T3E ***
               ...
               IMACH( 7) = 2
               IMACH( 8) = 63
               write(*,*) "ALIGN/legendre.f90> ERROR: I1MACH tried to call I1MCR1, which is not available."
               STOP 1
!               CALL I1MCR1(IMACH(9), K, 32767, 16777215, 16777215)
               ...
               IMACH(16) = 1024
               GO TO 35
20             write(*,*) "ALIGN/legendre.f90> ERROR: I1MACH tried to call I1MCR1, which is not available."
               STOP 1
