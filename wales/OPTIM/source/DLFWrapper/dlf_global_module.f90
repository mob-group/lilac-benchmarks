...
!! $Rev: 486 $
!! $Author: twk $
!! $URL: http://ccpforge.cse.rl.ac.uk/svn/dl-find/branches/release_chemsh3.5/dlf_global_module.f90 $
!! $Id: dlf_global_module.f90 486 2012-04-20 11:26:24Z twk $
!!
!! COPYRIGHT
!!
...
module dlf_global
  ...
  type glob_type
    ...
    integer  :: newlbfgs_mem   ! number of steps in LBFGS memory
