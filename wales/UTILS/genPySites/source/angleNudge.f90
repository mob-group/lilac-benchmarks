SUBROUTINE ANGLENUDGE(iErr,nP,nC,nE,lPARAMS,lESIZE,lEPOS,lERMAT,lCPOS,lCRMAT)
...
implicit none
      ...
      DOUBLE PRECISION :: nudgeX, nudgeY, nudgeZ, X, Y, Z, d, a, b1, b2, db, g1, g2, dg,  aa, ab, ac, ra, rb, rc, s, u1, u2, ca, cb, cg
...
10 FORMAT(8(1xf10.4))
     ...
     END DO
      ...
      DO curC=1,nC,1
         ...
         lCPOS(curC,1)=DBLE((curC-1)*numPairs)*X
         lCPOS(curC,2)=DBLE((curC-1)*numPairs)*Y
         lCPOS(curC,3)=DBLE((curC-1)*numPairs)*Z
