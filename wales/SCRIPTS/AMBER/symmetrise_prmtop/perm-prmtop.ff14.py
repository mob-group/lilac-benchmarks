...
###############################################################
## Adapted from original to account for ff14SB                # 
## by K. Roeder (kr366)                                       #
##                                                            #
## Edyta Malolepsza                                           #
...
try:
   ...
   svn_lib = os.path.join(home, "svn/AMBERTOOLS/dat/leap/lib")
...
print '  amino12.lib'
aalib = open("%s/amino12.lib" % path).read()
...
######################################
## reading aminont12.lib library
######################################

print '  aminont12.lib'
aalib = open("%s/aminont12.lib" % svn_lib).read()
aa = string.split(aalib, "\n")
q1 = aa.index("!!index array str")
...
######################################
## reading aminoct12.lib library
######################################

print '  aminoct12.lib'
aalib = open("%s/aminoct12.lib" % path).read()
aa = string.split(aalib, "\n")
q1 = aa.index("!!index array str")
...
#####################################
## reading nucleic12.lib library
#####################################

print '  nucleic12.lib'
# check to see if the file is where expected or moved (as in AMBER14+)
aalib = open("%s/nucleic12.lib" % path).read()
aa = string.split(aalib, "\n")
q1 = aa.index("!!index array str")
q2 = aa.index("!entry.A.unit.atoms table  str name  str type  int typex  int resx  int flags  int seq  int elmnt  dbl chg")
...
group1 = ['CGLY','CALA','CVAL','CLEU','CMET','CILE','CSER','CTHR','CCYS','CLYS','CPRO','CTRP','CHIP','CHIE','CHID','CHYP']

#################################################################
## groups of nucleic residues according to permutation behaviour
#################################################################

group2 = ['DA', 'DA3', 'DA5', 'DAN', 'A', 'A3', 'A5', 'AN']
group3 = ['DC', 'DC3', 'DC5', 'DCN', 'C', 'C3', 'C5', 'CN']
group4 = ['DG', 'DG3', 'DG5', 'DGN', 'G', 'G3', 'G5', 'GN']
group5 = ['DT', 'DT3', 'DT5', 'DTN', 'U', 'U3', 'U5', 'UN' , 'OHE' ] ## nothing to do
