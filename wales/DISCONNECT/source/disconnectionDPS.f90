...
! Parameters 
   ...
   INTEGER :: BASIN_NO, ERR, H_PG, MIN1, MIN2, MIN_TEMP, N_BR, N_COLS, &
      & N_NODES, N_TS, PATH, USED, BIG_ONES, BASIN_GMIN, GMIN, GMIN_CONN
   ...
   INTEGER NBASIN, NCOUNT, J2, LUNIT, GETUNIT, K1, K2, K3, K4, I2
...
!  Set global minimum energy to 0.
   ...
   DO I=1,N_TS
      IF (TS(I)%E.LE.M(TS(I)%MIN1)) THEN
         PRINT '(A,G20.10,A)','WARNING *** energy of ts (= ',TS(I)%E,') is lower than min1:'
      ...
      IF (TS(I)%E.LE.M(TS(I)%MIN2)) THEN
         PRINT '(A,G20.10,A)','WARNING *** energy of ts (= ',TS(I)%E,') is lower than min2:'
...
!               PRINT*, 'Rmax, map(Rmax)= ', RMAX, MAP(RMAX) 
              ...
              ENDDO   
              IF (K1.EQ.K2) THEN
     WRITE (20, '(A, I8, A, I8, A, I8, A, I8)')'Nodes ', MINPAIRS(R,Q,2), &
       ' and ' , MINPAIRS(R,Q,1), ' BASIN ', K2, ' joins Colour ', r
