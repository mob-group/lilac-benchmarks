...
ncoords = int(sys.argv[1])
n_coord_lines = int(np.floor(ncoords/3.0)) + ncoords%3
print "Expecting ", n_coord_lines, "lines of coordinates"
...
E1, sym1 = read_pathinfo(fname1, 3, n_coord_lines)
E2, sym2 = read_pathinfo(fname2, 3, n_coord_lines)
    
nconfigs = len(E1)
print "nconfigs", nconfigs
if len(E2)!=len(E1):
    print "The path.info have different numbers of entries."
    success = False
