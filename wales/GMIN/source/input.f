...
C         #concat "\"
      ...
      INTEGER NITEM, NERROR, NCR, LOC, ITEM, LAST, K, LC
...
C> \name BLOCK DATA INBLK 
      ...
      COMMON /BUFFER/ CHAR(800)
      LOGICAL SKIPBL, CLEAR, ECHO, CAT
      INTEGER NITEM, NERROR, NCR, LOC, LINE, ITEM, LAST, K
      COMMON /BUFINF/ ITEM, NITEM, LOC(80), LINE, SKIPBL, CLEAR, NCR,
     &                NERROR, ECHO, LAST, CAT
...
C Declarations {{{ 
      ...
      COMMON /BUFFER/ CHAR(800)
      LOGICAL SKIPBL, CLEAR, ECHO, CAT
      INTEGER NITEM, NERROR, NCR, LOC, LINE, ITEM, LAST, K, KXSIGN, KXIMP, KX, I2, I1, NITEMS, I
      COMMON /BUFINF/ ITEM, NITEM, LOC(80), LINE, SKIPBL, CLEAR, NCR,
     &                NERROR, ECHO, LAST, CAT
...
C Declarations {{{
      ...
      LOGICAL SKIPBL, CLEAR, ECHO, CAT
      INTEGER K, NCR, NERROR, ITEM, NITEM, LOC, LAST, L, LINE, NITEMS, I1, I2, I, NEST
