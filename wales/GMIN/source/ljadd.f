...
C
      ...
      USE COMMONS, ONLY : LJADDEPS, VT, NADDTARGET, MYUNIT
      IMPLICIT NONE
      ...
      IF (GTEST.AND.(.NOT.STEST)) THEN
         DO J1=1,N
            ...
            DO J2=J1+1,N
               ...
               VT(J2)=VT(J2)+DUMMY
               ENERGY=ENERGY+DUMMY
!              WRITE(MYUNIT,'(A,4I8,3G20.10)') 'J1,J2,MJ1,MJ2,EPS,DUMMY,ENERGY=',J1,J2,MJ1,MJ2,LJADDEPS(MJ2,MJ1),DUMMY,ENERGY
               DIST=DIST*R6
               IF (MJ1.EQ.MJ2) THEN ! repulsive part only
...
C*****************************************************************************
      ...
      USE MODHESS
      USE COMMONS, ONLY : LJADDEPS, NADDTARGET
      IMPLICIT NONE
...
C
      ...
      USE COMMONS, ONLY : LJADDREP, LJADDATT, NADDTARGET, MYUNIT, NUMNN, TANHFAC, LJADDCUTOFF, LJADDNN, LJADDREFNORM
      IMPLICIT NONE
...
C
      ...
      USE COMMONS, ONLY : LJADDREP, LJADDATT, VT, NADDTARGET, MYUNIT
      IMPLICIT NONE
      INTEGER N, J1, J2, J3, J4, MJ1, MJ2
      LOGICAL GTEST, STEST
      DOUBLE PRECISION X(3*N), ENERGY, R6,
...
C*****************************************************************************
      ...
      USE MODHESS
      USE COMMONS, ONLY : LJADDREP, LJADDATT, NADDTARGET
      IMPLICIT NONE
      INTEGER N, J1, J2, J3, J4, J5, J6, MJ1, MJ2
      DOUBLE PRECISION G(N,N), R14(N,N), R8(N,N),
     1                 R2(N,N), F(N,N), 
