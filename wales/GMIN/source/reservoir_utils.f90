...
SUBROUTINE RESERVOIR_CALC_EHSA(Xl,Yl,Zl,WELLLOW,POTEL,POTEL_HSA,BETA,LBFGS_ITERATIONS)
   ...
   !ENDDO
   CALL ALIGN_DECIDE(RESPOINTS(:,WELLLOW),CONFIGQUENCHED(:),NATOMS,DEBUG,BOXLX,BOXLY,BOXLZ,.FALSE.,&
...
!   CALL ALIGN_DECIDE(RESPOINTS(:,WELLLOW),CONFIGALIGNED(:),NATOMS,DEBUG,BOXLX,BOXLY,BOXLZ,.FALSE.,&
!&       TWOD,DISTANCEq,DIST2,RIGID,RMATBEST)
   ...
   CALL ALIGN_DECIDE(CONFIGQUENCHED(:),CONFIGALIGNED(:),NATOMS,DEBUG,BOXLX,BOXLY,BOXLZ,.FALSE.,&
     &       TWOD,DISTANCE,DIST2,RIGID,RMATBEST)
