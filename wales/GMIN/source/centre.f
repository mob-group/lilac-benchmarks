...
! jwrm2> If using OPP with alchemical moves, the last coordinates are the
! potential parameters. Fiddle NATOMS so these aren't included.
      IF (OPPT .AND. OPP_MODE .EQ. 3) THEN
         NATOMS = NATOMS - 1
      END IF
