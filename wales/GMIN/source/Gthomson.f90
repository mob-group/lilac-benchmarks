...
!   Foundation, Inc., 59 Temple Place, Suite 330, Boston, MA  02111-1307  USA
      ...
      USE COMMONS, ONLY: GTHOMMET, GTHOMPOT, GThomsonRho, GThomsonSigma, NATOMS, GTHOMSONBINN, GTHOMSONBIND
      IMPLICIT NONE
...
SUBROUTINE GTHOMSONHESSIAN(X,HESS)
  ...
  USE commons, ONLY: GTHOMMET, GTHOMPOT, GThomsonSigma, NATOMS, GTHOMSONBINN, GTHOMSONBIND
  IMPLICIT NONE
