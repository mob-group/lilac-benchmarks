...
C________________________________________________________________________
      ...
      periodicBC = P_B_C
      CM = CofM
      write(MYUNIT,*) 'PBC and CM are : ',P_B_C, CofM
C________________________________________________________________________
...
C---------------------------------------------------------------
      ...
      if (natom .ne. natom_check) then
        write(MYUNIT,'(2(A,I6))') 'Natom: ',natom,' Natom_check:',natom_check
        write(MYUNIT,*) 'ERROR : Number of atom does not match input file'
        stop
      endif
