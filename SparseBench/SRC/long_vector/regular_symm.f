...
C Tue Jan 23 13:30:11 EST 2001
C
C----------------------------------------------------------------
...
C Arguments
      integer n1,n2,n3
      real*8 a(n1*n2*n3,0:3),x(n1*n2*n3),y(n1*n2*n3)
C Externals
...
C Local
     ...
     >     + a(i-1,1)*x(i-1) + a(i-n1,2)*x(i-n1)
      ...
      do i=n23+1,n123-n23
         y(i) = a(i,0)*x(i) 
     >     + a(i,1)*x(i+1) + a(i,2)*x(i+n1) + a(i,3)*x(i+n23)
     >     + a(i-1,1)*x(i-1) + a(i-n1,2)*x(i-n1) + a(i-n23,3)*x(i-n23)
      end do
...
C Arguments
      integer n1,n2,n3
      real*8 a(n1,n2,n3,0:3),m(n1,n2,n3)
C Local
      integer i1,i2,i3
...
C     Arguments
      integer n1,n2,n3
      real*8 a(n1,n2,n3,0:3),m(n1,n2,n3),x(n1,n2,n3),y(n1,n2,n3)
     >     ,tmp(n1,n2,n3)
C Externals
      external starttimer,stoptimer
      real*8 starttimer,stoptimer
...
C Arguments
      ...
      real*8 a(n1,n2,n3,0:3),m(n1,0:hbw,n2,n3),
      ...
      do i3=1,n3
         do i2=1,n2
            ...
            if (i2.gt.1) then
               ...
               do i1=1,n1
                  tmp(i1) = tmp(i1)-a(i1,i2-1,i3,2)*y(i1,i2-1,i3)
               end do
               flops = flops + 2*n1
            end if
            if (i3.gt.1) then
               do i1=1,n1
                  tmp(i1) = tmp(i1)-a(i1,i2,i3-1,3)*y(i1,i2,i3-1)
               end do
               flops = flops + 2*n1
            end if
