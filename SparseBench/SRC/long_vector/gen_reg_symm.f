...
C Arguments
      integer n1,n2,n3
      real*8 a(n1,n2,n3,0:3),cof(n1+1,n2+1,n3+1,3)
C Local variables
     ...
     >                       a(i1,i2,i3,p) = -c
                        ...
                        c = cof(i1,i2,i3,-p)
                        if (.not.(no1.or.no2.or.no3))
     >                       a(i1+o1,i2+o2,i3+o3,0) =
     >                       a(i1+o1,i2+o2,i3+o3,0) + c
                     end if
                  end do
               end do
            end do
...
C Local
     ...
     >              'A(',row,',',row+n12,') = ',a(i1,i2,i3,3),';'
               if (i1.lt.n1) write(matdump_unit,*)
     >              'A(',row+1,',',row,') = ',a(i1,i2,i3,1),';'
               if (i2.lt.n2) write(matdump_unit,*)
     >              'A(',row+n1,',',row,') = ',a(i1,i2,i3,2),';'
               if (i3.lt.n3) write(matdump_unit,*)
     >              'A(',row+n12,',',row,') = ',a(i1,i2,i3,3),';'
               row = row+1
            end do
         end do
      end do
...
C Local
      ...
      do i3=1,n3
         do i2=1,n2
            do i1=1,n1
               read(matdump_unit,*) (mat(i1,i2,i3,p),p=0,3)
            end do
         end do
      end do
      close(matdump_unit) 
...
C Local
      ...
      do i3=1,n3
         do i2=1,n2
            do i1=1,n1
               write(matdump_unit,*) (mat(i1,i2,i3,p),p=0,3)
            end do
         end do
      end do
      close(matdump_unit) 
