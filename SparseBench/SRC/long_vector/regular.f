...
C Tue Jan 23 13:30:10 EST 2001
C
C----------------------------------------------------------------
...
C Arguments
      integer n1,n2,n3
      real*8 a(n1*n2*n3,-3:3),x(n1*n2*n3),y(n1*n2*n3)
C Externals
...
C Local
      ...
      do i=1,1
         y(i) = a(i,0)*x(i) 
     >     + a(i,1)*x(i+1) + a(i,2)*x(i+n1) + a(i,3)*x(i+n23)
      end do
      do i=2,n1
         y(i) = a(i,0)*x(i) 
     >     + a(i,1)*x(i+1) + a(i,2)*x(i+n1) + a(i,3)*x(i+n23)
     ...
     >     + a(i,-1)*x(i-1) + a(i,-2)*x(i-n1) + a(i,-3)*x(i-n23)
      ...
      do i=n123-n23+1,n123-n1
         y(i) = a(i,0)*x(i)   + a(i,1)*x(i+1) + a(i,2)*x(i+n1)
     >     + a(i,-1)*x(i-1) + a(i,-2)*x(i-n1) + a(i,-3)*x(i-n23)
      end do
      do i=n123-n1+1,n123-1
         y(i) = a(i,0)*x(i)   + a(i,1)*x(i+1)
     >     + a(i,-1)*x(i-1) + a(i,-2)*x(i-n1) + a(i,-3)*x(i-n23)
      end do
      do i=n123,n123
         y(i) = a(i,0)*x(i)
...
C Local
      ...
      do i=1,n123-1
         y(i+1) = y(i+1) + a(i,1)*x(i)
      end do
      do i=1,n123-n3
         y(i+n3) = y(i+n3) + a(i,2)*x(i)
      end do
      do i=1,n123-n23
         y(i+n23) = y(i+n23) + a(i,3)*x(i)
      end do
      do i=1,n123-1
         y(i) = y(i) + a(i+1,-1)*x(i+1)
      end do
      do i=1,n123-n3
         y(i) = y(i) + a(i+n3,-2)*x(i+n3)
      end do
      do i=1,n123-n23
         y(i) = y(i) + a(i+n23,-3)*x(i+n23)
      end do
      call add_mult_flops( n2*n3*(n1+4*(n1-1)) + n3*2*(n2-1)*2*n1
     >     + 2*(n3-1)*n2*2*n1 )
      t = stoptimer()-t
...
C Arguments
      integer n1,n2,n3
      real*8 a(n1,n2,n3,-3:3),m(n1,n2,n3)
C Local
      integer i1,i2,i3
...
C     Arguments
      integer n1,n2,n3
      real*8 a(n1,n2,n3,-3:3),m(n1,n2,n3),x(n1,n2,n3),y(n1,n2,n3)
     >     ,tmp(n1,n2,n3)
C Externals
      external starttimer,stoptimer
      real*8 starttimer,stoptimer
...
C Arguments
      ...
      real*8 a(n1,n2,n3,-3:3),m(n1,-hbw:hbw,n2,n3),
...
C Forward solve (D+L)y=x
      do i3=1,n3
         do i2=1,n2
            ...
            if (i2.gt.1) then
               call vecview(a(1,i2-1,i3,2),'bac2',0,n1)
               do i1=1,n1
                  tmp(i1) = tmp(i1)-a(i1,i2,i3,-2)*y(i1,i2-1,i3)
               end do
               flops = flops + 2*n1
            end if
            if (i3.gt.1) then
               do i1=1,n1
                  tmp(i1) = tmp(i1)-a(i1,i2,i3,-3)*y(i1,i2,i3-1)
               end do
               flops = flops + 2*n1
            end if
